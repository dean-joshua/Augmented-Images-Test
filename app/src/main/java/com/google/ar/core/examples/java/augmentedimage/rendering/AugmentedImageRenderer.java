...
public class AugmentedImageRenderer {
  ...
  // Render for Cube
  private final ObjectRenderer cubeRenderer = new ObjectRenderer();
  ...
  public void createOnGlThread(Context context) throws IOException {
    ...
    cubeRenderer.createOnGlThread(
            context, "models/spaceship/spaceship.obj","models/spaceship/None_Base_Color.png");
    cubeRenderer.setMaterialProperties(0.0f, 3.5f, 1.0f, 6.0f);
  ...
  public void draw(
    ...
    anchorPose.compose(andyPoseInImageSpace).toMatrix(modelMatrix, 0);
    cubeRenderer.updateModelMatrix(modelMatrix, 0.005f);
    cubeRenderer.draw(viewMatrix, projectionMatrix, colorCorrectionRgba, tintColor);

    /*Pose cubeModelLocalOffset = Pose.makeTranslation(
            0.0f,
            0.1f,
            0.0f);
    anchorPose.compose(cubeModelLocalOffset).toMatrix(modelMatrix, 0);
    cubeRenderer.updateModelMatrix(modelMatrix, 0.005f); // 0.05f is a Magic number to scale
    cubeRenderer.draw(viewMatrix, projectionMatrix, colorCorrectionRgba, tintColor);*/
